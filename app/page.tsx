        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 lg:flex">
            {[{ label: "Home", href: "#" }, ...nav].map((item) => (
              <a key={item.label} href={item.href} className="text-sm font-semibold tracking-wider text-stone-300 transition hover:text-white">
                {item.label}
              </a>
            ))}
            <a href="#contact" className="rounded-full bg-[#917158] px-5 py-2.5 text-sm font-semibold tracking-wider text-white transition hover:-translate-y-0.5 hover:bg-[#7B5C45]">
              Contact
            </a>
          </nav>
        </div>
